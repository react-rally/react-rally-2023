  ...
  return (
    <section className="highlight">
      <p>
        ...
        management, hooks, <del>isomorphic</del> universal JavaScript, and
        more. Whether you're a seasoned developer who has been using React
        since before it was cool, or a newcomer to the scene, React Rally has
